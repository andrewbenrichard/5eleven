...
let routes = [
    ...
    {
        path: "/prime/dashboard/product/add-new",
        name: "add-product",
        component: require("./components/dashboardComponents/forms/addProduct.vue")
            .default,
        beforeEnter: (to, from, next) => {
            if (!store.getters["auth/authenticated"]) {
                return next({
    ...
    {
        path: "/prime/dashboard/product/materials/:slug",
        component: require("./components/dashboardComponents/forms/productMaterial.vue")
            .default,
        beforeEnter: (to, from, next) => {
            if (!store.getters["auth/authenticated"]) {
                return next({
    ...
    {
        path: "/prime/dashboard/product/gallery/:slug",
        component: require("./components/dashboardComponents/forms/productGallery.vue")
            .default,
        beforeEnter: (to, from, next) => {
            if (!store.getters["auth/authenticated"]) {
                return next({
    ...
    {
        path: "/prime/dashboard/material-types",
        name: "material-types",
        component: require("./components/dashboardComponents/materialTypes.vue")
            .default,
        beforeEnter: (to, from, next) => {
            if (!store.getters["auth/authenticated"]) {
                return next({
    ...
    {
        path: "/prime/dashboard/material-types/cat/:slug",
        component: require("./components/dashboardComponents/forms/CatMaterials.vue")
            .default,
        beforeEnter: (to, from, next) => {
            if (!store.getters["auth/authenticated"]) {
                return next({
    ...
    {
        path: "/prime/dashboard/material-types/cat/sub/:slug",
        component: require("./components/dashboardComponents/forms/SubCatMaterials.vue")
            .default,
        beforeEnter: (to, from, next) => {
            if (!store.getters["auth/authenticated"]) {
                return next({
